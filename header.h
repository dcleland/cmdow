...
enum
{
    WM_CASCADE_WINDOWS = (403),
    WM_TILE_HORIZONTALLY = (404),
    WM_TILE_VERTICALLY = (405),
    WM_MINIMIZE_ALL = (415),
    WM_UNDO_WINDOWS = (413)
};
...
enum
{
    MEMERR = 0,  /* Memory allocation failed */
    MOVERR = 1,  /* /MOV command requires left and top arguments */
    SIZERR = 2,  /* /SIZ command requires width and height agrguments */
    RENERR = 3,  /* /REN command requires a new caption to be specified */
    UNRARG = 4,  /* Unrecognized argument(s). Use CMDOW /? for help */
    CONARG = 5,  /* Conflicting argument(s). Use CMDOW /? for help */
    INCARG = 6,  /* Incorrect argument(s). Use CMDOW /? for help */
    NOCAPT = 7,  /* A window must be specified by its caption or handle */
    NOTFND = 8,  /* The specified window was not found */
...
enum
{
    MAXTASKS = 50 /* Maximum size of task queue */
};
